...
public class AdminController implements Initializable {
  ...
  @FXML
    ...
    @FXML
    private void addbus(ActionEvent event) throws IOException {
    ...
    @FXML
    private void addtrain(ActionEvent event) throws IOException {
        AnchorPane pane = FXMLLoader.load(getClass().getResource("AddedTrainList.fxml"));
        adminsubpane.getChildren().setAll(pane);
    }

    @FXML
    private void addplane(ActionEvent event) throws IOException {
